/* 
  ...
  Apesar de se chamarem 'lógicos', eles podem ser aplicados a valores de 
  qualquer tipo, não só booleanos.
  E seu resultado também pode ser de qualquer tipo.
*/

/* 
  (||) OR
  Na programação clássica, o OU lógico é usado somente para manipular valores
  booleanos. 
  Se quaisquer um de seus argumentos for true, retorna true,
  caso contrário retorna false.
  Em JavaScript, o operador é um pouco mais complicado e também mais poderoso.
  Mas vamos ver o que acontece com valores booleanos.
*/
...
// Se um operando não é um booleano, ele é convertido para 1 para o cálculo.
...
/* 
  ...
  Calcula operandos da esquerda para direita, para cada operando, converte-o
  para booleano.
  Se o resultado for true, para e retorna o valor original daquele operando
  (antes da conversão).
...
/* 
  ...
  Significa que || processa os argumentos até o primeiro valor truthy ser 
  encontrado e o valor é retornado imediatamente, sem nem tocar nos outros argumentos.
  A importância dessa feature fica mais óbvio quando o operando não é só um valor,
  mas uma expressão com um efeito colateral como uma atribuição de variável ou
  chamada de função.
*/

// aqui o operador para imediatamente no true, então o alert() não é executado
true || alert('not printed');
// aqui a função é executada, pois o operador vê o false.
false || alert('printed');

// Algumas vezes, essa característica é usada para executar comandos, somente
// se a condição na esquerda é falsy (valor que é convertido para false).
