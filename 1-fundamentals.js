...
// ex.: constantes 'hard-coded' devem ser escritas em maiúsculo, e constantes
// que vão ser calculadas em tempo de execução são nomeadas em camelCase.

// É possível declarar múltiplas variáveis em uma só linha, mas
// pela legibilidade do código declare uma por linha.
let userName = 'Anonymous', userID = '923923', userIsVerified = false;

// ou ainda declare de uma maneira mais legível 
// (aqui entra questão de estética e convenções da equipe etc)
